...
%                     s_summaryname     = fullfile(groupSurfDir_glm,sprintf('s%s.group.con_%s-%s_taskCon.func.gii', hemI{h},taskNames{cc}, con_vs));
    ...
    case 'SURF:mdtb:noiseCeiling_get_transitions_id_data'
        ...
        vararginoptions(varargin, {'ppmethod', 'experiment_num', 'glm', 'atlas_res', 'con_vs', 'smooth', 'kernel'});
...
%         atlas_res   = 32;           %% atlas resolution can either be 32 or 64
        ...
        vararginoptions(varargin, {'sn', 'glm', 'experiment_num', 'ppmethod', 'which', 'con_vs', 'atlas_res', 'replaceNaNs'})
...
%         colorbar;
    ...
    case 'SUIT:mdtb:groupmap_con_transitions_id'
        ...
        vararginoptions(varargin,{'sn', 'ppmethod', 'atlas_res', 'experiment_num', 'glm', 'replaceNaN', 'convs', 'smooth', 'kernel'});
